      ...
      <div className="grid gap-6 md:grid-cols-3 max-w-6xl mx-auto p-4 mt-24">
        <Card className="relative overflow-hidden">
          <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              ...
              garantindo um terreno nivelado e adequado para suas necessidades.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden">
          <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              ...
              assegurando que cada etapa seja realizada com qualidade e rapidez.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden">
          <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Com um processo controlado e seguro, sua obra conta com a proteção
              necessária para evitar problemas futuros.
            </p>
          </CardContent>
        </Card>
      </div>
